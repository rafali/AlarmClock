...
import com.rafali.alarm.persistance.AlarmDatabaseHelper;
...
class BaseTest {
    ...
    protected void assertTimerView(String s) {
        ...
        Cortado.onView().withId(com.rafali.alarm.R.id.hours_tens).check().matches(withText("" + s.charAt(0)));
        Cortado.onView().withId(com.rafali.alarm.R.id.hours_ones).check().matches(withText("" + s.charAt(1)));
        Cortado.onView().withId(com.rafali.alarm.R.id.minutes_tens).check().matches(withText("" + s.charAt(3)));
        Cortado.onView().withId(com.rafali.alarm.R.id.minutes_ones).check().matches(withText("" + s.charAt(4)));
    }
